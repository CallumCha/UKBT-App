...
class _MatchesTabState extends State<MatchesTab> {
  String? selectedPool;
  bool showKnockoutMatches = false;
      ...
      builder: (context, snapshot) {
        ...
        return Column(
          children: [
                ...
                children: [
                  ...pools.map((pool) {
                    ...
                    return Padding(
                      ...
                      child: ChoiceChip(
                        label: Text(poolName),
                        selected: selectedPool == poolName && !showKnockoutMatches,
                        onSelected: (bool selected) {
                          setState(() {
                            selectedPool = selected ? poolName : null;
                            showKnockoutMatches = false;
                          });
                        },
                      ),
                    );
                  ...
                  Padding(
                    ...
                    child: ChoiceChip(
                      label: Text('Knockout'),
                      selected: showKnockoutMatches,
                      onSelected: (bool selected) {
                        setState(() {
                          showKnockoutMatches = selected;
                          selectedPool = null;
                        });
                      },
                    ),
            ...
            Expanded(
              child: showKnockoutMatches ? _buildKnockoutMatches() : _buildPoolMatches(pools),
            ),
          ],
        );
      },
          ...
          itemBuilder: (context, index) {
            ...
            return Column(
              ...
              children: [
                ...
                ...roundMatches.map((match) => _buildMatchTile(match, 'knockout')).toList(),
              ],
            );
          },
        );
  ...
  Widget _buildPoolMatches(List<QueryDocumentSnapshot> pools) {
      ...
      builder: (context, matchSnapshots) {
        ...
        return ListView(
          children: sortedMatchIndices.expand((matchIndex) {
            ...
            return matchGroup.where((match) => selectedPool == null || match['poolName'] == selectedPool).map((match) => _buildMatchTile(match, match['poolName'])).toList();
          }).toList(),
        );
      },
    );
  ...
  Widget _buildMatchTile(Map<String, dynamic> match, String poolName) {
      ...
      builder: (context, teamSnapshots) {
        ...
        return FutureBuilder<List<DocumentSnapshot>>(
          ...
          builder: (context, userSnapshots) {
            ...
            return ListTile(
              title: Text(
                'Match ${poolName == 'knockout' ? match['round'] : poolName}',
